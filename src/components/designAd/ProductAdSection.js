...
import { productNameData } from "@/data/BusinessTypeData/ProductNameData";
...
const ProductAdSection = () => {
  ...
  const handleGenerate = async (e) => {
    ...
    const finalImg = await axios
      .post(`http://localhost:3000/api/genAds/genProductAds`, {
          ...
          productAds.map((img_src) => {
            return (
              <Image
                ...
                src={img_src}
                alt="demoAdImg"
                key={productAds.indexOf(img_src)}
